...
zenorak_controller_motor provides a ros2_control system hardware interface for a mobile robot with a differential-drive base and a 3-DOF linear-actuated manipulator.
